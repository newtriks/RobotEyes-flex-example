package com.newloop.roboteyes.drivers.flex
{
    ...
    public class TextAreaDriver extends InteractiveObjectDriver
    {
        private var _textArea:TextArea;

        public function TextAreaDriver(tf:TextArea)
        {
            _textArea=tf;
            super(_textArea);
        }
        ...
        public function enterText(newText:String):void
        {
            ...
            _textArea.text=newText;
            _textArea.dispatchEvent(new Event(Event.CHANGE))
        }

        public function appendText(newText:String):void
        {
            _textArea.appendText(newText);
        }

        public function checkText(testText:String):Boolean
        {
            return _textArea.text==testText;
        }
        ...
        {
            return __contains(_textArea.text, testText);
        }

        public function isNumeric():Boolean
        {
            return __isNumeric(_textArea.text);
        }

        public function wordCountIs(noWords:uint):Boolean
        {
            return (wordCount(_textArea.text)==noWords);
        }
